...
paramNames = ['L', 'L11', 'W', 'W3', 'W4', 'T', 'T1', 'h4', 'h7','T2', 'T3']
varParameters = []
...
for vari in range(1): #len(varParameters)
	...
	for j in range(1):
		...
		T = vars[5] # MAXIMUM THICKNESS (cm)
		T1 = T * vars[6]

		l4 = L2
		h4 = vars[7] # heights expressed in terms of h4, since it's the max height
		h7 = vars[8] * h4 # height of tine tip from plane
		l1 = 0.27 * l4
		h1 = 0.15 * h4
		l2 = 0.54 * l4
		h2 = 0.45 * h4
		...
		if loadn==1:
			...
			faces1 = f1.findAt(((0, 0, T1/2/100), ), ((0, 0.0, (T1+(T-T1))/2/100), ))
