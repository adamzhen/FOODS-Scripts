...
def getResults(ModelName):
    ...
    print odbName
    odb = visualization.openOdb(odbName, readOnly=False)
    lastFrame = odb.steps['Step-1'].frames[-1]
    print 'odb open'
 
    #o = session.odbs['C:/Users/kevinlieb/abaqus/Model-1.odb']
    o = odb
    p = odb.rootAssembly.instances['PART-1-1']
    e1 = p.elements
    pickedElements =(e1[0:], )
    o.rootAssembly.ElementSet(name = 'ALL_PART', elements = pickedElements)
    ...
    mass = mdb.models['Model-1'].parts['Part-1'].getMassProperties()['mass']

    DataFile = open('PostData-MassVM.txt','a')
